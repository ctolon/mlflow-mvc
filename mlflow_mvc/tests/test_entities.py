...
def test_run_data_entity_properties():
    ...
    public_method_names = [method for method in dir(run_data_model) if callable(getattr(run_data_model, method)) if not method.startswith('_')]  # 'private' methods start from _
...
def test_run_info_entity_properties():
    ...
    public_method_names = [method for method in dir(run_info_model) if callable(getattr(run_info_model, method)) if not method.startswith('_')]  # 'private' methods start from _
...
def test_experiment_entity_properties():
    ...
    public_method_names = [method for method in dir(experiment_model) if callable(getattr(experiment_model, method)) if not method.startswith('_')]  # 'private' methods start from _
    for method in public_method_names:
...
def test_model_version_entity_properties():
    ...
    public_method_names = [method for method in dir(model_version) if callable(getattr(model_version, method)) if not method.startswith('_')]  # 'private' methods start from _
    for method in public_method_names:
